...
def RestoreWifi():
    ...
    subprocess.run(["sudo", "service", "networking", "restart"])
    subprocess.run(["sudo","dhcpcd","wlan0"])
...
#connect to Network!
subprocess.run(["sudo","wpa_cli","add_network","set_network","0",'"'+BSSIDs[numpy.argmin(Signals)]+'"',"set_network","0","psk",'"' + Solved +'"', "reconnect", "quit"])
